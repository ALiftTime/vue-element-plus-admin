module.exports = {
  ...
  rules: {
    ...
    'vue/one-component-per-file': 'off', // 关闭检查每个文件是否只有一个组件
    ...
    'vue/multi-word-component-names': 0, // 关闭组件名必须为多个
    // 'vue/no-deprecated-destroyed-lifecycle': 2, // 禁止使用已弃用destroyed和beforeDestroy
    // 'vue/no-deprecated-slot-scope-attribute': 2, // 禁止弃用slot-scope属性
    // 'vue/component-definition-name-casing': 2, // 强制组件名大写
